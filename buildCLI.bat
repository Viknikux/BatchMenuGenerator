...
REM ============================================================
REM Build BatchMenuGeneratorCLI - Pure Win32 C++ CLI Application
REM Statically linked MSVCRT - Zero external dependencies
REM ============================================================

set "SRC=BatchMenuGeneratorCLI.cpp"
set "OUT=BatchMenuGeneratorCLI.exe"
set "RC_SRC=app.rc"
set "RES=app.res"
...
REM Compile the resource script into a binary resource file (keeps your custom icon!)
...
echo.
echo === Compiling BatchMenuGenerator CLI ===
echo.

REM Changed /SUBSYSTEM:WINDOWS to /SUBSYSTEM:CONSOLE for the command line environment
cl.exe /nologo /O2 /Oi /Ot /GL /MT /EHsc /W4 /wd4100 /wd4101 /wd4189 /wd4458 ^
    ...
    %SRC% %RES% /Fe%OUT% /link /SUBSYSTEM:CONSOLE /LTCG ^
